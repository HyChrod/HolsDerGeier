...
public class AestheticGeier extends HolsDerGeierSpieler {
	...
	private int valenceStrategy(int points) throws IllegalArgumentException {
		...
		if(points > 10) returnValue = Collections.max(ownCardsAvailableList);
			...
			switch (points) {
				//VALENCE 1
				case 10: returnValue = (!ownCardsAvailableList.contains(15) || enemyCardsAvailableList.contains(15)) ? Collections.min(ownCardsAvailableList) : 15; break;
				case 9: returnValue = (!ownCardsAvailableList.contains(14) || enemyCardsAvailableList.contains(14)) ? Collections.min(ownCardsAvailableList) : 14; break;

				//VALENCE 2
				case 8: returnValue = (ownCardsAvailableList.contains(13)) ? 13 : Collections.min(ownCardsAvailableList); break;
				case 7:  returnValue = (ownCardsAvailableList.contains(12)) ? 12 : Collections.min(ownCardsAvailableList); break;
				case 6:  returnValue = (ownCardsAvailableList.contains(11)) ? 11 : Collections.min(ownCardsAvailableList); break;
				case 5:
				case -5: returnValue = takeCardBetween(10,6); break;

				//VALENCE 3
				case 4:
				case -4:  returnValue = takeCardBetween(8,6); break;
				case 3:
				case -3: returnValue = takeCardBetween(6,4); break;
				case 2:
				case -2: returnValue = takeCardBetween(4,2); break;

				//Valence 4
				case 1:
				case -1: returnValue = takeCardBetween(2,1); break;

				//Valence 5
				case 0 : returnValue = Collections.min(ownCardsAvailableList); break;
	...
	/**
	 * Diese Methode dient nur zu Debugging-Zwecken, sie gibt folgende Werte in der Konsole aus:
	 * @see #ownCardsAvailableList,
	 * @see #enemyCardsAvailableList,
	 * @see #pointCardsAvailableList,
	 * @see #ownScore,
	 * @see #enemyScore
	 */
	private void debuggingOutput(){
		System.out.println("Own Cards:   " + ownCardsAvailableList);
		System.out.println("Enemy Cards: " + enemyCardsAvailableList);
		System.out.println("Point Cards: " + pointCardsAvailableList);
		System.out.println("OwnScore: " + ownScore + "   EnemyScore: " + enemyScore);
	}
