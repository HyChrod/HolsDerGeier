...
public class AltenhofSpiessBot extends HolsDerGeierSpieler {
    ...
    */
	...
	public int gibKarte(int naechsteKarte) {
	   ////System.out.println("Framework gibt vor: " + naechsteKarte);
	   ////System.out.println();
       int ret=-99;
       int letzeKarteGegner = getHdg().letzterZug(getNummer() == 1 ? 0 : 1);
       int letzteKarteGegner=letzeKarteGegner;
       
       if (letzteKarteGegner!=-99 && letzteKarteGegner!=-1001&&letzteKarteGegner!=-1002);
       ...
       ////System.out.println("Ich lege " + ret + "!");
       return ret;
    }
