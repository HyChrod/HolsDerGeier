...
public class Bot1 extends HolsDerGeierSpieler {
	...
	private void addCards() {
		if (myNumber == 0) {
			playedCards.add(getHdg().letzterZug(0));
			gegnerKarten.add(getHdg().letzterZug(1));
		}
		if (myNumber == 1) {
			playedCards.add(getHdg().letzterZug(1));
			gegnerKarten.add(getHdg().letzterZug(0));
		}
