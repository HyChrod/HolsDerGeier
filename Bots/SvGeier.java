...
public class SvGeier extends HolsDerGeierSpieler {
    /**
     * ArrayLists für unsere Karten, die des Gegners, und die der Geier/Mäuse-Karten
    */
	private HolsDerGeierSpieler myHolsDerGeier;
...
public void reset () {
    ...
    */
	...
	public int gibKarte(int naechsteKarte) {    	
    	if(myCards.size()!=15){
    		enemyCards.add(getHdg().letzterZug(0));
    	}else{
    		enemyCards.add(0);
    	}
